...
#java -jar jenkins-cli.jar -s http://localhost:8080/ install-plugin instant-messaging
#java -jar jenkins-cli.jar -s http://localhost:8080/ install-plugin jabber
...
#java -jar jenkins-cli.jar -s http://localhost:8080/ install-plugin build-keeper-plugin
...
#java -jar jenkins-cli.jar -s http://localhost:8080/ install-plugin scm-sync-configuration
#java -jar jenkins-cli.jar -s http://localhost:8080/ install-plugin svn-tag
